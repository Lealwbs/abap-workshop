...
DATA: tmp_test_value TYPE i VALUE 0.
...
IF tmp_test_value EQ 1.
  ...
  ctg_int->run_contingency_process( EXPORTING is_main_branch_info   = is_branch_info
                                    CHANGING  ot_server_check_nfe_t = gt_active_server ).
  EXIT.
ENDIF.

" ----------------------------------------------------------------------------
" Código legado abaixo (versão antiga deste include) mantido temporariamente.
" Será removido assim que a nova versão acima estiver testada e validada.
" ----------------------------------------------------------------------------
